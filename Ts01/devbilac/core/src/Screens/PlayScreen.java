...
public class PlayScreen implements Screen {
	...
	public PlayScreen(DevBilac game) {
		...
		// laterais.
		gamePort = new FitViewport(DevBilac.V_WIDHT / DevBilac.PPM2, DevBilac.V_HEIGHT / DevBilac.PPM2, gamecam);
	...
	public void criarProfessor() {
		...
		Vector2[] position = { new Vector2(20, (float) 21), new Vector2(200, (float) 21),
				new Vector2(400, (float) 21) };
